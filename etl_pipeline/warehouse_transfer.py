...
try:
    ...
    print(f"Error inserting into dim_company: {e}")
...
try:
    ...
    print(f"Error inserting into dim_date: {e}")
...
try:
    ...
    print(f"Error inserting into fact_prices: {e}")
...
try:
    ...
    print(f"Error inserting into fact_fundamentals: {e}")
...
try:
    ...
    print(f"Error inserting into fact_financials: {e}")
...
try:
    ...
    print(f"Error inserting into fact_metrics: {e}")
